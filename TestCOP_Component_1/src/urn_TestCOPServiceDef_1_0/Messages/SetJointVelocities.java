...
public class SetJointVelocities extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x0603;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public SetJointVelocities.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public SetJointVelocities.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public SetJointVelocities.AppHeader assign(AppHeader value)
		{
	...
	public static class  Body
	{
		public static class  JointVelocityList
		{
			public static class  JointVelocityRec
			{
				public static class  JointVelocity
				{
					...
					public SetJointVelocities.Body.JointVelocityList.JointVelocityRec.JointVelocity assign(JointVelocity value)
					{
				...
				public SetJointVelocities.Body.JointVelocityList.JointVelocityRec.JointVelocity getJointVelocity()
				{
				...
				public SetJointVelocities.Body.JointVelocityList.JointVelocityRec assign(JointVelocityRec value)
				{
			...
			public SetJointVelocities.Body.JointVelocityList.JointVelocityRec getElement(int index)
			{
			...
			public SetJointVelocities.Body.JointVelocityList assign(JointVelocityList value)
			{
		...
		public SetJointVelocities.Body.JointVelocityList getJointVelocityList()
		{
		...
		public SetJointVelocities.Body assign(Body value)
		{
	...
	public SetJointVelocities.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public SetJointVelocities.Body getBody()
	{
		return m_Body;
	}
	...
	public SetJointVelocities setAs(SetJointVelocities value)
	{
	...
	public boolean isEqual(SetJointVelocities value)
	{
	...
	public boolean notEquals(SetJointVelocities value)
	{
		return !isEqual(value);
	}
	
	public SetJointVelocities()
	{
	...
	public  SetJointVelocities(SetJointVelocities value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
