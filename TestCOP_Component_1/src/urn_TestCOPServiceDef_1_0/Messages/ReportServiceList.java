...
public class ReportServiceList extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x4b04;
	...
	public static class  MsgHeader
	{
		public static class  HeaderRec
		{
			...
			public ReportServiceList.MsgHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public ReportServiceList.MsgHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public ReportServiceList.MsgHeader assign(MsgHeader value)
		{
	...
	public static class  Body
	{
		public static class  SubsystemList
		{
			public static class  SubsystemSeq
			{
				public static class  SubsystemRec
				{
					...
					public ReportServiceList.Body.SubsystemList.SubsystemSeq.SubsystemRec assign(SubsystemRec value)
					{
				...
				public static class  NodeList
				{
					public static class  NodeSeq
					{
						public static class  NodeRec
						{
							...
							public ReportServiceList.Body.SubsystemList.SubsystemSeq.NodeList.NodeSeq.NodeRec assign(NodeRec value)
							{
						...
						public static class  ComponentList
						{
							public static class  ComponentSeq
							{
								public static class  ComponentRec
								{
									...
									public ReportServiceList.Body.SubsystemList.SubsystemSeq.NodeList.NodeSeq.ComponentList.ComponentSeq.ComponentRec assign(ComponentRec value)
									{
								...
								public static class  ServiceList
								{
									public static class  ServiceRec
									{
										...
										public ReportServiceList.Body.SubsystemList.SubsystemSeq.NodeList.NodeSeq.ComponentList.ComponentSeq.ServiceList.ServiceRec assign(ServiceRec value)
										{
											m_URI = value.m_URI;
									...
									public ReportServiceList.Body.SubsystemList.SubsystemSeq.NodeList.NodeSeq.ComponentList.ComponentSeq.ServiceList.ServiceRec getElement(int index)
									{
									...
									public ReportServiceList.Body.SubsystemList.SubsystemSeq.NodeList.NodeSeq.ComponentList.ComponentSeq.ServiceList assign(ServiceList value)
									{
										m_ServiceRec.clear();
								...
								public ReportServiceList.Body.SubsystemList.SubsystemSeq.NodeList.NodeSeq.ComponentList.ComponentSeq.ComponentRec getComponentRec()
								{
								...
								public ReportServiceList.Body.SubsystemList.SubsystemSeq.NodeList.NodeSeq.ComponentList.ComponentSeq.ServiceList getServiceList()
								{
								...
								public ReportServiceList.Body.SubsystemList.SubsystemSeq.NodeList.NodeSeq.ComponentList.ComponentSeq assign(ComponentSeq value)
								{
							...
							public ReportServiceList.Body.SubsystemList.SubsystemSeq.NodeList.NodeSeq.ComponentList.ComponentSeq getElement(int index)
							{
							...
							public ReportServiceList.Body.SubsystemList.SubsystemSeq.NodeList.NodeSeq.ComponentList assign(ComponentList value)
							{
						...
						public ReportServiceList.Body.SubsystemList.SubsystemSeq.NodeList.NodeSeq.NodeRec getNodeRec()
						{
							return m_NodeRec;
						}
						...
						public ReportServiceList.Body.SubsystemList.SubsystemSeq.NodeList.NodeSeq.ComponentList getComponentList()
						{
						...
						public ReportServiceList.Body.SubsystemList.SubsystemSeq.NodeList.NodeSeq assign(NodeSeq value)
						{
					...
					public ReportServiceList.Body.SubsystemList.SubsystemSeq.NodeList.NodeSeq getElement(int index)
					{
					...
					public ReportServiceList.Body.SubsystemList.SubsystemSeq.NodeList assign(NodeList value)
					{
						m_NodeSeq.clear();
				...
				public ReportServiceList.Body.SubsystemList.SubsystemSeq.SubsystemRec getSubsystemRec()
				{
				...
				public ReportServiceList.Body.SubsystemList.SubsystemSeq.NodeList getNodeList()
				{
					return m_NodeList;
				}
				...
				public ReportServiceList.Body.SubsystemList.SubsystemSeq assign(SubsystemSeq value)
				{
			...
			public ReportServiceList.Body.SubsystemList.SubsystemSeq getElement(int index)
			{
			...
			public ReportServiceList.Body.SubsystemList assign(SubsystemList value)
			{
		...
		public ReportServiceList.Body.SubsystemList getSubsystemList()
		{
		...
		public ReportServiceList.Body assign(Body value)
		{
	...
	public ReportServiceList.MsgHeader getMsgHeader()
	{
		return m_MsgHeader;
	}
	...
	public ReportServiceList.Body getBody()
	{
		return m_Body;
	}
	...
	public ReportServiceList setAs(ReportServiceList value)
	{
	...
	public boolean isEqual(ReportServiceList value)
	{
	...
	public boolean notEquals(ReportServiceList value)
	{
		return !isEqual(value);
	}
	
	public ReportServiceList()
	{
	...
	public  ReportServiceList(ReportServiceList value)
	{
		/// Initiliaze the protected variables
		m_MsgHeader = new MsgHeader();
		m_Body = new Body();
