...
public class ReportGlobalPose extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x4402;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public ReportGlobalPose.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public ReportGlobalPose.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public ReportGlobalPose.AppHeader assign(AppHeader value)
		{
	...
	{
		public static class  GlobalPoseRec
		{
			public static class  TimeStamp
			{
			
				protected GlobalPoseRec m_parent;
				protected long m_SubFields;
			
				public void setParent(GlobalPoseRec parent)
				{
					m_parent = parent;
				}
				...
				public ReportGlobalPose.Body.GlobalPoseRec.TimeStamp assign(TimeStamp value)
				{
			...
			public ReportGlobalPose.Body.GlobalPoseRec.TimeStamp getTimeStamp()
			{
				return m_TimeStamp;
			}
			...
			public ReportGlobalPose.Body.GlobalPoseRec assign(GlobalPoseRec value)
			{
			...
			public boolean isEqual(GlobalPoseRec value)
			{
			...
			public boolean notEquals(GlobalPoseRec value)
			{
				return !this.isEqual(value);
			}
			
			public GlobalPoseRec()
			{
				m_parent = null;
			...
			public GlobalPoseRec(GlobalPoseRec value)
			{
				/// Initiliaze the protected variables
				m_parent = null;
				m_PresenceVector = new BitSet();
		...
		protected GlobalPoseRec m_GlobalPoseRec;
	
		public ReportGlobalPose.Body.GlobalPoseRec getGlobalPoseRec()
		{
			return m_GlobalPoseRec;
		}
		
		public void setGlobalPoseRec(GlobalPoseRec value)
		{
		...
		public ReportGlobalPose.Body assign(Body value)
		{
		...
		{
			if (!m_GlobalPoseRec.isEqual(value.getGlobalPoseRec()))
			{
				return false;
			}
			/// This code is currently not supported
		...
		public Body()
		{
			m_GlobalPoseRec = new GlobalPoseRec();
			m_GlobalPoseRec.setParent(this);
		}
	...
	public ReportGlobalPose.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public ReportGlobalPose.Body getBody()
	{
		return m_Body;
	}
	...
	public ReportGlobalPose setAs(ReportGlobalPose value)
	{
	...
	public boolean isEqual(ReportGlobalPose value)
	{
	...
	public boolean notEquals(ReportGlobalPose value)
	{
		return !isEqual(value);
	}
	
	public ReportGlobalPose()
	{
	...
	public  ReportGlobalPose(ReportGlobalPose value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
