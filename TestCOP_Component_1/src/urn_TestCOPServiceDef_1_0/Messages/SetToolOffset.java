...
public class SetToolOffset extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x0604;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public SetToolOffset.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public SetToolOffset.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public SetToolOffset.AppHeader assign(AppHeader value)
		{
	...
	public static class  Body
	{
		public static class  ToolPointRec
		{
			...
			public SetToolOffset.Body.ToolPointRec assign(ToolPointRec value)
			{
		...
		public SetToolOffset.Body.ToolPointRec getToolPointRec()
		{
		...
		public SetToolOffset.Body assign(Body value)
		{
	...
	public SetToolOffset.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public SetToolOffset.Body getBody()
	{
		return m_Body;
	}
	...
	public SetToolOffset setAs(SetToolOffset value)
	{
	...
	public boolean isEqual(SetToolOffset value)
	{
	...
	public boolean notEquals(SetToolOffset value)
	{
		return !isEqual(value);
	}
	
	public SetToolOffset()
	{
	...
	public  SetToolOffset(SetToolOffset value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
