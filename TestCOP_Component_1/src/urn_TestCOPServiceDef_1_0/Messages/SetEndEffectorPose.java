...
public class SetEndEffectorPose extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x0610;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public SetEndEffectorPose.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public SetEndEffectorPose.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public SetEndEffectorPose.AppHeader assign(AppHeader value)
		{
	...
	public static class  Body
	{
		public static class  EndEffectorPoseRec
		{
			...
			public SetEndEffectorPose.Body.EndEffectorPoseRec assign(EndEffectorPoseRec value)
			{
		...
		public SetEndEffectorPose.Body.EndEffectorPoseRec getEndEffectorPoseRec()
		{
		...
		public SetEndEffectorPose.Body assign(Body value)
		{
	...
	public SetEndEffectorPose.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public SetEndEffectorPose.Body getBody()
	{
		return m_Body;
	}
	...
	public SetEndEffectorPose setAs(SetEndEffectorPose value)
	{
	...
	public boolean isEqual(SetEndEffectorPose value)
	{
	...
	public boolean notEquals(SetEndEffectorPose value)
	{
		return !isEqual(value);
	}
	
	public SetEndEffectorPose()
	{
	...
	public  SetEndEffectorPose(SetEndEffectorPose value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
