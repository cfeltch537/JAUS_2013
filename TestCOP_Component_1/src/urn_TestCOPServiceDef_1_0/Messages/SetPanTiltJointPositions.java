...
public class SetPanTiltJointPositions extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x0622;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public SetPanTiltJointPositions.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public SetPanTiltJointPositions.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public SetPanTiltJointPositions.AppHeader assign(AppHeader value)
		{
	...
	public static class  Body
	{
		public static class  PanTiltJointPositionRec
		{
			...
			public SetPanTiltJointPositions.Body.PanTiltJointPositionRec assign(PanTiltJointPositionRec value)
			{
		...
		public SetPanTiltJointPositions.Body.PanTiltJointPositionRec getPanTiltJointPositionRec()
		{
		...
		public SetPanTiltJointPositions.Body assign(Body value)
		{
	...
	public SetPanTiltJointPositions.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public SetPanTiltJointPositions.Body getBody()
	{
		return m_Body;
	}
	...
	public SetPanTiltJointPositions setAs(SetPanTiltJointPositions value)
	{
	...
	public boolean isEqual(SetPanTiltJointPositions value)
	{
	...
	public boolean notEquals(SetPanTiltJointPositions value)
	{
		return !isEqual(value);
	}
	
	public SetPanTiltJointPositions()
	{
	...
	public  SetPanTiltJointPositions(SetPanTiltJointPositions value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
