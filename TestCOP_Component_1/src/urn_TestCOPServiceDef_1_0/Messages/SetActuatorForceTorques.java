...
public class SetActuatorForceTorques extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x0613;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public SetActuatorForceTorques.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public SetActuatorForceTorques.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public SetActuatorForceTorques.AppHeader assign(AppHeader value)
		{
	...
	public static class  Body
	{
		public static class  ActuatorForceTorqueList
		{
			public static class  ActuatorForceTorqueRec
			{
				public static class  JointForceTorque
				{
					...
					public SetActuatorForceTorques.Body.ActuatorForceTorqueList.ActuatorForceTorqueRec.JointForceTorque assign(JointForceTorque value)
					{
				...
				public SetActuatorForceTorques.Body.ActuatorForceTorqueList.ActuatorForceTorqueRec.JointForceTorque getJointForceTorque()
				{
				...
				public SetActuatorForceTorques.Body.ActuatorForceTorqueList.ActuatorForceTorqueRec assign(ActuatorForceTorqueRec value)
				{
			...
			public SetActuatorForceTorques.Body.ActuatorForceTorqueList.ActuatorForceTorqueRec getElement(int index)
			{
			...
			public SetActuatorForceTorques.Body.ActuatorForceTorqueList assign(ActuatorForceTorqueList value)
			{
		...
		public SetActuatorForceTorques.Body.ActuatorForceTorqueList getActuatorForceTorqueList()
		{
		...
		public SetActuatorForceTorques.Body assign(Body value)
		{
	...
	public SetActuatorForceTorques.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public SetActuatorForceTorques.Body getBody()
	{
		return m_Body;
	}
	...
	public SetActuatorForceTorques setAs(SetActuatorForceTorques value)
	{
	...
	public boolean isEqual(SetActuatorForceTorques value)
	{
	...
	public boolean notEquals(SetActuatorForceTorques value)
	{
		return !isEqual(value);
	}
	
	public SetActuatorForceTorques()
	{
	...
	public  SetActuatorForceTorques(SetActuatorForceTorques value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
