...
public class ReportGlobalVector extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x4407;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public ReportGlobalVector.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public ReportGlobalVector.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public ReportGlobalVector.AppHeader assign(AppHeader value)
		{
	...
	public static class  Body
	{
		public static class  GlobalVectorRec
		{
			...
			public ReportGlobalVector.Body.GlobalVectorRec assign(GlobalVectorRec value)
			{
		...
		public ReportGlobalVector.Body.GlobalVectorRec getGlobalVectorRec()
		{
		...
		public ReportGlobalVector.Body assign(Body value)
		{
	...
	public ReportGlobalVector.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public ReportGlobalVector.Body getBody()
	{
		return m_Body;
	}
	...
	public ReportGlobalVector setAs(ReportGlobalVector value)
	{
	...
	public boolean isEqual(ReportGlobalVector value)
	{
	...
	public boolean notEquals(ReportGlobalVector value)
	{
		return !isEqual(value);
	}
	
	public ReportGlobalVector()
	{
	...
	public  ReportGlobalVector(ReportGlobalVector value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
