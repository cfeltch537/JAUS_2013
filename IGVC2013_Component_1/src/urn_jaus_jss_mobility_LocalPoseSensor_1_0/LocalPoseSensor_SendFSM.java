...
public class LocalPoseSensor_SendFSM extends StateMachine{
	...
	public LocalPoseSensor_SendFSM(Transport_SendFSM pTransport_SendFSM, Events_SendFSM pEvents_SendFSM, AccessControl_SendFSM pAccessControl_SendFSM)
{
