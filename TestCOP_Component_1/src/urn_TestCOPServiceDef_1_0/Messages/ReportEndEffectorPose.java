...
public class ReportEndEffectorPose extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x4615;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public ReportEndEffectorPose.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public ReportEndEffectorPose.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public ReportEndEffectorPose.AppHeader assign(AppHeader value)
		{
	...
	public static class  Body
	{
		public static class  EndEffectorPoseRec
		{
			...
			public ReportEndEffectorPose.Body.EndEffectorPoseRec assign(EndEffectorPoseRec value)
			{
		...
		public ReportEndEffectorPose.Body.EndEffectorPoseRec getEndEffectorPoseRec()
		{
		...
		public ReportEndEffectorPose.Body assign(Body value)
		{
	...
	public ReportEndEffectorPose.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public ReportEndEffectorPose.Body getBody()
	{
		return m_Body;
	}
	...
	public ReportEndEffectorPose setAs(ReportEndEffectorPose value)
	{
	...
	public boolean isEqual(ReportEndEffectorPose value)
	{
	...
	public boolean notEquals(ReportEndEffectorPose value)
	{
		return !isEqual(value);
	}
	
	public ReportEndEffectorPose()
	{
	...
	public  ReportEndEffectorPose(ReportEndEffectorPose value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
