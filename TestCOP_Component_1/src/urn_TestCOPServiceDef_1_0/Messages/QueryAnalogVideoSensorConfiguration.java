...
public class QueryAnalogVideoSensorConfiguration extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x2811;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public QueryAnalogVideoSensorConfiguration.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public QueryAnalogVideoSensorConfiguration.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public QueryAnalogVideoSensorConfiguration.AppHeader assign(AppHeader value)
		{
	...
	public static class  Body
	{
		public static class  SensorIdList
		{
			public static class  SensorIdRec
			{
				...
				public QueryAnalogVideoSensorConfiguration.Body.SensorIdList.SensorIdRec assign(SensorIdRec value)
				{
			...
			public QueryAnalogVideoSensorConfiguration.Body.SensorIdList.SensorIdRec getElement(int index)
			{
			...
			public QueryAnalogVideoSensorConfiguration.Body.SensorIdList assign(SensorIdList value)
			{
				m_SensorIdRec.clear();
		...
		public QueryAnalogVideoSensorConfiguration.Body.SensorIdList getSensorIdList()
		{
		...
		public QueryAnalogVideoSensorConfiguration.Body assign(Body value)
		{
	...
	public QueryAnalogVideoSensorConfiguration.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public QueryAnalogVideoSensorConfiguration.Body getBody()
	{
		return m_Body;
	}
	...
	public QueryAnalogVideoSensorConfiguration setAs(QueryAnalogVideoSensorConfiguration value)
	{
	...
	public boolean isEqual(QueryAnalogVideoSensorConfiguration value)
	{
	...
	public boolean notEquals(QueryAnalogVideoSensorConfiguration value)
	{
		return !isEqual(value);
	}
	
	public QueryAnalogVideoSensorConfiguration()
	{
	...
	public  QueryAnalogVideoSensorConfiguration(QueryAnalogVideoSensorConfiguration value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
