...
public class EventsService extends Service{
	...
	public synchronized boolean processTransitions(InternalEvent ie)
	{
		...
		// Invoke the FSM transition for this event.
			try
			{
				if ((done == false) && ie.getName().compareTo("Receive") == 0 && (ie.getSource().compareTo("Events_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("EventOccurred") == 0 && (ie.getSource().compareTo("Events_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("EventError") == 0 && (ie.getSource().compareTo("Events_ReceiveFSM") != 0))
				{
	...
	public synchronized boolean defaultTransitions(InternalEvent ie)
	{
		...
		// Invoke the FSM transition for this event.
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("Send") == 0 && (ie.getSource().compareTo("Events_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("BroadcastLocal") == 0 && (ie.getSource().compareTo("Events_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("BroadcastGlobal") == 0 && (ie.getSource().compareTo("Events_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("Receive") == 0 && (ie.getSource().compareTo("Events_SendFSM") != 0))
				{
					Receive casted_ie = (Receive) ie;
					int id = (int) (casted_ie.getBody().getReceiveRec().getMessagePayload().getData().getShort() & 0xffff);
					if ( id == CreateEvent.ID)
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("EventOccurred") == 0 && (ie.getSource().compareTo("Events_SendFSM") != 0))
				{
					EventOccurred casted_ie = (EventOccurred) ie;
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("EventError") == 0 && (ie.getSource().compareTo("Events_SendFSM") != 0))
				{
					EventError casted_ie = (EventError) ie;
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("Send") == 0 && (ie.getSource().compareTo("Events_SendFSM") != 0))
				{
					Send casted_ie = (Send) ie;
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("BroadcastLocal") == 0 && (ie.getSource().compareTo("Events_SendFSM") != 0))
				{
					BroadcastLocal casted_ie = (BroadcastLocal) ie;
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("BroadcastGlobal") == 0 && (ie.getSource().compareTo("Events_SendFSM") != 0))
				{
					BroadcastGlobal casted_ie = (BroadcastGlobal) ie;
