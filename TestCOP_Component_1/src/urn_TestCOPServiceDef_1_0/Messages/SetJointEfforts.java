...
public class SetJointEfforts extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x0601;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public SetJointEfforts.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public SetJointEfforts.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public SetJointEfforts.AppHeader assign(AppHeader value)
		{
	...
	public static class  Body
	{
		public static class  JointEffortList
		{
			public static class  JointEffortRec
			{
				...
				public SetJointEfforts.Body.JointEffortList.JointEffortRec assign(JointEffortRec value)
				{
			...
			public SetJointEfforts.Body.JointEffortList.JointEffortRec getElement(int index)
			{
			...
			public SetJointEfforts.Body.JointEffortList assign(JointEffortList value)
			{
		...
		public SetJointEfforts.Body.JointEffortList getJointEffortList()
		{
		...
		public SetJointEfforts.Body assign(Body value)
		{
	...
	public SetJointEfforts.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public SetJointEfforts.Body getBody()
	{
		return m_Body;
	}
	...
	public SetJointEfforts setAs(SetJointEfforts value)
	{
	...
	public boolean isEqual(SetJointEfforts value)
	{
	...
	public boolean notEquals(SetJointEfforts value)
	{
		return !isEqual(value);
	}
	
	public SetJointEfforts()
	{
	...
	public  SetJointEfforts(SetJointEfforts value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
