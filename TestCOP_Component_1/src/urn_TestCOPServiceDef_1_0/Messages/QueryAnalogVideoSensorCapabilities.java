...
public class QueryAnalogVideoSensorCapabilities extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x2810;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public QueryAnalogVideoSensorCapabilities.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public QueryAnalogVideoSensorCapabilities.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public QueryAnalogVideoSensorCapabilities.AppHeader assign(AppHeader value)
		{
	...
	public static class  Body
	{
		public static class  SensorIdList
		{
			public static class  SensorIdRec
			{
				...
				public QueryAnalogVideoSensorCapabilities.Body.SensorIdList.SensorIdRec assign(SensorIdRec value)
				{
			...
			public QueryAnalogVideoSensorCapabilities.Body.SensorIdList.SensorIdRec getElement(int index)
			{
			...
			public QueryAnalogVideoSensorCapabilities.Body.SensorIdList assign(SensorIdList value)
			{
				m_SensorIdRec.clear();
		...
		public QueryAnalogVideoSensorCapabilities.Body.SensorIdList getSensorIdList()
		{
		...
		public QueryAnalogVideoSensorCapabilities.Body assign(Body value)
		{
	...
	public QueryAnalogVideoSensorCapabilities.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public QueryAnalogVideoSensorCapabilities.Body getBody()
	{
		return m_Body;
	}
	...
	public QueryAnalogVideoSensorCapabilities setAs(QueryAnalogVideoSensorCapabilities value)
	{
	...
	public boolean isEqual(QueryAnalogVideoSensorCapabilities value)
	{
	...
	public boolean notEquals(QueryAnalogVideoSensorCapabilities value)
	{
		return !isEqual(value);
	}
	
	public QueryAnalogVideoSensorCapabilities()
	{
	...
	public  QueryAnalogVideoSensorCapabilities(QueryAnalogVideoSensorCapabilities value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
