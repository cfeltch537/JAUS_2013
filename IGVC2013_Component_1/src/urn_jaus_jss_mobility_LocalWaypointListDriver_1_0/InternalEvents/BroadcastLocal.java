package src.urn_jaus_jss_mobility_LocalWaypointListDriver_1_0.InternalEvents;
	...
	public static class  Body
	{
		public static class  SendRec
		{
			public static class  MessagePayload
			{
				...
				public BroadcastLocal.Body.SendRec.MessagePayload assign(MessagePayload value)
				{
			...
			public BroadcastLocal.Body.SendRec.MessagePayload getMessagePayload()
			{
			...
			public BroadcastLocal.Body.SendRec assign(SendRec value)
			{
		...
		public BroadcastLocal.Body.SendRec getSendRec()
		{
			return m_SendRec;
		}
