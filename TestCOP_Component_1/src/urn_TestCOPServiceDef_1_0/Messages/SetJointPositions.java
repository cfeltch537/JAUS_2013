...
public class SetJointPositions extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x0602;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public SetJointPositions.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public SetJointPositions.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public SetJointPositions.AppHeader assign(AppHeader value)
		{
	...
	public static class  Body
	{
		public static class  JointPositionList
		{
			public static class  JointPositionRec
			{
				public static class  JointPosition
				{
					...
					public SetJointPositions.Body.JointPositionList.JointPositionRec.JointPosition assign(JointPosition value)
					{
				...
				public SetJointPositions.Body.JointPositionList.JointPositionRec.JointPosition getJointPosition()
				{
				...
				public SetJointPositions.Body.JointPositionList.JointPositionRec assign(JointPositionRec value)
				{
			...
			public SetJointPositions.Body.JointPositionList.JointPositionRec getElement(int index)
			{
			...
			public SetJointPositions.Body.JointPositionList assign(JointPositionList value)
			{
		...
		public SetJointPositions.Body.JointPositionList getJointPositionList()
		{
		...
		public SetJointPositions.Body assign(Body value)
		{
	...
	public SetJointPositions.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public SetJointPositions.Body getBody()
	{
		return m_Body;
	}
	...
	public SetJointPositions setAs(SetJointPositions value)
	{
	...
	public boolean isEqual(SetJointPositions value)
	{
	...
	public boolean notEquals(SetJointPositions value)
	{
	...
	public  SetJointPositions(SetJointPositions value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
