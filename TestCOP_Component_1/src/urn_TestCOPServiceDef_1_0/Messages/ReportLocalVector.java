...
public class ReportLocalVector extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x4408;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public ReportLocalVector.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public ReportLocalVector.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public ReportLocalVector.AppHeader assign(AppHeader value)
		{
	...
	public static class  Body
	{
		public static class  LocalVectorRec
		{
			...
			public ReportLocalVector.Body.LocalVectorRec assign(LocalVectorRec value)
			{
		...
		public ReportLocalVector.Body.LocalVectorRec getLocalVectorRec()
		{
		...
		public ReportLocalVector.Body assign(Body value)
		{
	...
	public ReportLocalVector.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public ReportLocalVector.Body getBody()
	{
		return m_Body;
	}
	...
	public ReportLocalVector setAs(ReportLocalVector value)
	{
	...
	public boolean isEqual(ReportLocalVector value)
	{
	...
	public boolean notEquals(ReportLocalVector value)
	{
		return !isEqual(value);
	}
	
	public ReportLocalVector()
	{
	...
	public  ReportLocalVector(ReportLocalVector value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
