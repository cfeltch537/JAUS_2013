...
public class SetTime extends Message
{
	...
	public static class  MsgHeader
	{
		public static class  HeaderRec
		{
			...
			public SetTime.MsgHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public SetTime.MsgHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public SetTime.MsgHeader assign(MsgHeader value)
		{
	...
	public static class  Body
	{
		public static class  TimeRec
		{
			public static class  TimeStamp
			{
				...
				public SetTime.Body.TimeRec.TimeStamp assign(TimeStamp value)
				{
			...
			public static class  DateStamp
			{
				...
				public SetTime.Body.TimeRec.DateStamp assign(DateStamp value)
				{
					this.m_SubFields = value.m_SubFields;
			...
			public SetTime.Body.TimeRec.TimeStamp getTimeStamp()
			{
				return m_TimeStamp;
			}
			...
			public SetTime.Body.TimeRec.DateStamp getDateStamp()
			{
				return m_DateStamp;
			}
			...
			public SetTime.Body.TimeRec assign(TimeRec value)
			{
		...
		public SetTime.Body.TimeRec getTimeRec()
		{
			return m_TimeRec;
		}
		...
		public SetTime.Body assign(Body value)
		{
	...
	public SetTime.MsgHeader getMsgHeader()
	{
		return m_MsgHeader;
	}
	...
	public SetTime setAs(SetTime value)
	{
	...
	public boolean isEqual(SetTime value)
	{
	...
	public boolean notEquals(SetTime value)
	{
