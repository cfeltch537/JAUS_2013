...
public class SetVisualSensorConfiguration extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x0803;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public SetVisualSensorConfiguration.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public SetVisualSensorConfiguration.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public SetVisualSensorConfiguration.AppHeader assign(AppHeader value)
		{
	...
	{
		public static class  VisualSensorConfigurationSequence
		{
			public static class  RequestIdRec
			{
			
				protected VisualSensorConfigurationSequence m_parent;
				protected short m_RequestID;
			
				public void setParent(VisualSensorConfigurationSequence parent)
				{
					m_parent = parent;
				}
				...
				public SetVisualSensorConfiguration.Body.VisualSensorConfigurationSequence.RequestIdRec assign(RequestIdRec value)
				{
			...
			public static class  VisualSensorConfigurationList
			{
				public static class  VisualSensorConfigurationRec
				{
					...
					public SetVisualSensorConfiguration.Body.VisualSensorConfigurationSequence.VisualSensorConfigurationList.VisualSensorConfigurationRec assign(VisualSensorConfigurationRec value)
					{
				...
				public SetVisualSensorConfiguration.Body.VisualSensorConfigurationSequence.VisualSensorConfigurationList.VisualSensorConfigurationRec getElement(int index)
				{
				...
				public SetVisualSensorConfiguration.Body.VisualSensorConfigurationSequence.VisualSensorConfigurationList assign(VisualSensorConfigurationList value)
				{
			...
			public SetVisualSensorConfiguration.Body.VisualSensorConfigurationSequence.RequestIdRec getRequestIdRec()
			{
			...
			public SetVisualSensorConfiguration.Body.VisualSensorConfigurationSequence.VisualSensorConfigurationList getVisualSensorConfigurationList()
			{
			...
			public SetVisualSensorConfiguration.Body.VisualSensorConfigurationSequence assign(VisualSensorConfigurationSequence value)
			{
			...
			public boolean isEqual(VisualSensorConfigurationSequence value)
			{
				...
				if (!m_VisualSensorConfigurationList.isEqual(value.getVisualSensorConfigurationList()))
				{
					return false;
				}
			...
			public boolean notEquals(VisualSensorConfigurationSequence value)
			{
				return !this.isEqual(value);
			}
			
			public VisualSensorConfigurationSequence()
			{
				m_parent = null;
			...
			public VisualSensorConfigurationSequence(VisualSensorConfigurationSequence value)
			{
				/// Initiliaze the protected variables
				m_parent = null;
				m_RequestIdRec = new RequestIdRec();
		...
		protected VisualSensorConfigurationSequence m_VisualSensorConfigurationSequence;
	
		public SetVisualSensorConfiguration.Body.VisualSensorConfigurationSequence getVisualSensorConfigurationSequence()
		{
			return m_VisualSensorConfigurationSequence;
		}
		
		public int setVisualSensorConfigurationSequence(VisualSensorConfigurationSequence value)
		{
		...
		public SetVisualSensorConfiguration.Body assign(Body value)
		{
		...
		{
			if (!m_VisualSensorConfigurationSequence.isEqual(value.getVisualSensorConfigurationSequence()))
			{
				return false;
			}
			/// This code is currently not supported
		...
		public Body()
		{
			m_VisualSensorConfigurationSequence = new VisualSensorConfigurationSequence();
			m_VisualSensorConfigurationSequence.setParent(this);
		}
	...
	public SetVisualSensorConfiguration.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public SetVisualSensorConfiguration.Body getBody()
	{
		return m_Body;
	}
	...
	public SetVisualSensorConfiguration setAs(SetVisualSensorConfiguration value)
	{
	...
	public boolean isEqual(SetVisualSensorConfiguration value)
	{
	...
	public boolean notEquals(SetVisualSensorConfiguration value)
	{
		return !isEqual(value);
	}
	
	public SetVisualSensorConfiguration()
	{
	...
	public  SetVisualSensorConfiguration(SetVisualSensorConfiguration value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
