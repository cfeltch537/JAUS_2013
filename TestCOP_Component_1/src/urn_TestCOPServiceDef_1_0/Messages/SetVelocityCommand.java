...
public class SetVelocityCommand extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x0415;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public SetVelocityCommand.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public SetVelocityCommand.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public SetVelocityCommand.AppHeader assign(AppHeader value)
		{
	...
	public static class  Body
	{
		public static class  VelocityCommandRec
		{
			...
			public SetVelocityCommand.Body.VelocityCommandRec assign(VelocityCommandRec value)
			{
		...
		public SetVelocityCommand.Body.VelocityCommandRec getVelocityCommandRec()
		{
		...
		public SetVelocityCommand.Body assign(Body value)
		{
	...
	public SetVelocityCommand.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public SetVelocityCommand.Body getBody()
	{
		return m_Body;
	}
	...
	public SetVelocityCommand setAs(SetVelocityCommand value)
	{
	...
	public boolean isEqual(SetVelocityCommand value)
	{
	...
	public boolean notEquals(SetVelocityCommand value)
	{
	...
	public  SetVelocityCommand(SetVelocityCommand value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
