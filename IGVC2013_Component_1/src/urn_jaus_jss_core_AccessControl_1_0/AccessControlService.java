...
public class AccessControlService extends Service{
	...
	public synchronized boolean processTransitions(InternalEvent ie)
	{
		...
		// Invoke the FSM transition for this event.
			try
			{
				if ((done == false) && ie.getName().compareTo("InternalStateChange_To_AccessControl_ReceiveFSM_Receiving_Ready_Controlled") == 0 && (ie.getSource().compareTo("AccessControl_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("Receive") == 0 && (ie.getSource().compareTo("AccessControl_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("Timeout") == 0 && (ie.getSource().compareTo("AccessControl_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("InternalStateChange_To_AccessControl_ReceiveFSM_Receiving_Ready_NotControlled") == 0 && (ie.getSource().compareTo("AccessControl_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("InternalStateChange_To_AccessControl_ReceiveFSM_Receiving_Ready") == 0 && (ie.getSource().compareTo("AccessControl_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("InternalStateChange_To_AccessControl_ReceiveFSM_Receiving") == 0 && (ie.getSource().compareTo("AccessControl_ReceiveFSM") != 0))
				{
	...
	public synchronized boolean defaultTransitions(InternalEvent ie)
	{
		...
		// Invoke the FSM transition for this event.
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("EventOccurred") == 0 && (ie.getSource().compareTo("AccessControl_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("EventError") == 0 && (ie.getSource().compareTo("AccessControl_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("Send") == 0 && (ie.getSource().compareTo("AccessControl_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("BroadcastLocal") == 0 && (ie.getSource().compareTo("AccessControl_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("BroadcastGlobal") == 0 && (ie.getSource().compareTo("AccessControl_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("Receive") == 0 && (ie.getSource().compareTo("AccessControl_SendFSM") != 0))
				{
					Receive casted_ie = (Receive) ie;
					int id = (int) (casted_ie.getBody().getReceiveRec().getMessagePayload().getData().getShort() & 0xffff);
					if ( id == RequestControl.ID)
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("Timeout") == 0 && (ie.getSource().compareTo("AccessControl_SendFSM") != 0))
				{
					Timeout casted_ie = (Timeout) ie;
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("EventOccurred") == 0 && (ie.getSource().compareTo("AccessControl_SendFSM") != 0))
				{
					EventOccurred casted_ie = (EventOccurred) ie;
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("EventError") == 0 && (ie.getSource().compareTo("AccessControl_SendFSM") != 0))
				{
					EventError casted_ie = (EventError) ie;
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("Send") == 0 && (ie.getSource().compareTo("AccessControl_SendFSM") != 0))
				{
					Send casted_ie = (Send) ie;
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("BroadcastLocal") == 0 && (ie.getSource().compareTo("AccessControl_SendFSM") != 0))
				{
					BroadcastLocal casted_ie = (BroadcastLocal) ie;
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("BroadcastGlobal") == 0 && (ie.getSource().compareTo("AccessControl_SendFSM") != 0))
				{
					BroadcastGlobal casted_ie = (BroadcastGlobal) ie;
