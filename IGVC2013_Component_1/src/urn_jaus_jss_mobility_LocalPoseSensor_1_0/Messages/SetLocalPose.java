package src.urn_jaus_jss_mobility_LocalPoseSensor_1_0.Messages;
...
public class SetLocalPose extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x0403;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public SetLocalPose.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public SetLocalPose.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public SetLocalPose.AppHeader assign(AppHeader value)
		{
	...
	public static class  Body
	{
		public static class  LocalPoseRec
		{
			public static class  TimeStamp
			{
				...
				public SetLocalPose.Body.LocalPoseRec.TimeStamp assign(TimeStamp value)
				{
			...
			public SetLocalPose.Body.LocalPoseRec.TimeStamp getTimeStamp()
			{
				return m_TimeStamp;
			}
			...
			public SetLocalPose.Body.LocalPoseRec assign(LocalPoseRec value)
			{
		...
		public SetLocalPose.Body.LocalPoseRec getLocalPoseRec()
		{
		...
		public SetLocalPose.Body assign(Body value)
		{
	...
	public SetLocalPose.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public SetLocalPose.Body getBody()
	{
		return m_Body;
	}
	...
	public SetLocalPose setAs(SetLocalPose value)
	{
	...
	public boolean isEqual(SetLocalPose value)
	{
	...
	public boolean notEquals(SetLocalPose value)
	{
	...
	public  SetLocalPose(SetLocalPose value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
