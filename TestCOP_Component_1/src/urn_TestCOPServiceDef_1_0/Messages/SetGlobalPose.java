...
public class SetGlobalPose extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x0402;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public SetGlobalPose.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public SetGlobalPose.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public SetGlobalPose.AppHeader assign(AppHeader value)
		{
	...
	public static class  Body
	{
		public static class  GlobalPoseRec
		{
			public static class  TimeStamp
			{
				...
				public SetGlobalPose.Body.GlobalPoseRec.TimeStamp assign(TimeStamp value)
				{
			...
			public SetGlobalPose.Body.GlobalPoseRec.TimeStamp getTimeStamp()
			{
				return m_TimeStamp;
			}
			...
			public SetGlobalPose.Body.GlobalPoseRec assign(GlobalPoseRec value)
			{
		...
		public SetGlobalPose.Body.GlobalPoseRec getGlobalPoseRec()
		{
		...
		public SetGlobalPose.Body assign(Body value)
		{
	...
	public SetGlobalPose.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public SetGlobalPose.Body getBody()
	{
		return m_Body;
	}
	...
	public SetGlobalPose setAs(SetGlobalPose value)
	{
	...
	public boolean isEqual(SetGlobalPose value)
	{
	...
	public boolean notEquals(SetGlobalPose value)
	{
		return !isEqual(value);
	}
	
	public SetGlobalPose()
	{
	...
	public  SetGlobalPose(SetGlobalPose value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
