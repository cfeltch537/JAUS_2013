...
public class ReportWrenchEffort extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x4405;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public ReportWrenchEffort.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public ReportWrenchEffort.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public ReportWrenchEffort.AppHeader assign(AppHeader value)
		{
	...
	public static class  Body
	{
		public static class  WrenchEffortRec
		{
			...
			public ReportWrenchEffort.Body.WrenchEffortRec assign(WrenchEffortRec value)
			{
		...
		public ReportWrenchEffort.Body.WrenchEffortRec getWrenchEffortRec()
		{
		...
		public ReportWrenchEffort.Body assign(Body value)
		{
	...
	public ReportWrenchEffort.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public ReportWrenchEffort.Body getBody()
	{
		return m_Body;
	}
	...
	public ReportWrenchEffort setAs(ReportWrenchEffort value)
	{
	...
	public boolean isEqual(ReportWrenchEffort value)
	{
	...
	public boolean notEquals(ReportWrenchEffort value)
	{
		return !isEqual(value);
	}
	
	public ReportWrenchEffort()
	{
	...
	public  ReportWrenchEffort(ReportWrenchEffort value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
