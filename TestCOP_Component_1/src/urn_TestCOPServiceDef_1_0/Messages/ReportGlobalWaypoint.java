...
public class ReportGlobalWaypoint extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x440c;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public ReportGlobalWaypoint.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public ReportGlobalWaypoint.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public ReportGlobalWaypoint.AppHeader assign(AppHeader value)
		{
	...
	public static class  Body
	{
		public static class  GlobalWaypointRec
		{
			...
			public ReportGlobalWaypoint.Body.GlobalWaypointRec assign(GlobalWaypointRec value)
			{
		...
		public ReportGlobalWaypoint.Body.GlobalWaypointRec getGlobalWaypointRec()
		{
		...
		public ReportGlobalWaypoint.Body assign(Body value)
		{
	...
	public ReportGlobalWaypoint.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public ReportGlobalWaypoint.Body getBody()
	{
		return m_Body;
	}
	...
	public ReportGlobalWaypoint setAs(ReportGlobalWaypoint value)
	{
	...
	public boolean isEqual(ReportGlobalWaypoint value)
	{
	...
	public boolean notEquals(ReportGlobalWaypoint value)
	{
		return !isEqual(value);
	}
	
	public ReportGlobalWaypoint()
	{
	...
	public  ReportGlobalWaypoint(ReportGlobalWaypoint value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
