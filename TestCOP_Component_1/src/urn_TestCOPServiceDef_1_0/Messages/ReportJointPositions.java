...
public class ReportJointPositions extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x4602;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public ReportJointPositions.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public ReportJointPositions.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public ReportJointPositions.AppHeader assign(AppHeader value)
		{
	...
	public static class  Body
	{
		public static class  JointPositionList
		{
			public static class  JointPositionRec
			{
				public static class  JointPosition
				{
					...
					public ReportJointPositions.Body.JointPositionList.JointPositionRec.JointPosition assign(JointPosition value)
					{
				...
				public ReportJointPositions.Body.JointPositionList.JointPositionRec.JointPosition getJointPosition()
				{
				...
				public ReportJointPositions.Body.JointPositionList.JointPositionRec assign(JointPositionRec value)
				{
			...
			public ReportJointPositions.Body.JointPositionList.JointPositionRec getElement(int index)
			{
			...
			public ReportJointPositions.Body.JointPositionList assign(JointPositionList value)
			{
		...
		public ReportJointPositions.Body.JointPositionList getJointPositionList()
		{
		...
		public ReportJointPositions.Body assign(Body value)
		{
	...
	public ReportJointPositions.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public ReportJointPositions.Body getBody()
	{
		return m_Body;
	}
	...
	public ReportJointPositions setAs(ReportJointPositions value)
	{
	...
	public boolean isEqual(ReportJointPositions value)
	{
	...
	public boolean notEquals(ReportJointPositions value)
	{
		return !isEqual(value);
	}
	
	public ReportJointPositions()
	{
	...
	public  ReportJointPositions(ReportJointPositions value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
