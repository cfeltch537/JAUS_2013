...
public class SetRangeSensorConfiguration extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x0802;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public SetRangeSensorConfiguration.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public SetRangeSensorConfiguration.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public SetRangeSensorConfiguration.AppHeader assign(AppHeader value)
		{
	...
	{
		public static class  RangeSensorConfigurationSequence
		{
			public static class  RequestIdRec
			{
			
				protected RangeSensorConfigurationSequence m_parent;
				protected short m_RequestID;
			
				public void setParent(RangeSensorConfigurationSequence parent)
				{
					m_parent = parent;
				}
				...
				public SetRangeSensorConfiguration.Body.RangeSensorConfigurationSequence.RequestIdRec assign(RequestIdRec value)
				{
			...
			public static class  RangeSensorConfigurationList
			{
				public static class  RangeSensorConfigurationRec
				{
					...
					public SetRangeSensorConfiguration.Body.RangeSensorConfigurationSequence.RangeSensorConfigurationList.RangeSensorConfigurationRec assign(RangeSensorConfigurationRec value)
					{
				...
				public SetRangeSensorConfiguration.Body.RangeSensorConfigurationSequence.RangeSensorConfigurationList.RangeSensorConfigurationRec getElement(int index)
				{
				...
				public SetRangeSensorConfiguration.Body.RangeSensorConfigurationSequence.RangeSensorConfigurationList assign(RangeSensorConfigurationList value)
				{
			...
			public SetRangeSensorConfiguration.Body.RangeSensorConfigurationSequence.RequestIdRec getRequestIdRec()
			{
			...
			public SetRangeSensorConfiguration.Body.RangeSensorConfigurationSequence.RangeSensorConfigurationList getRangeSensorConfigurationList()
			{
			...
			public SetRangeSensorConfiguration.Body.RangeSensorConfigurationSequence assign(RangeSensorConfigurationSequence value)
			{
			...
			public boolean isEqual(RangeSensorConfigurationSequence value)
			{
				...
				if (!m_RangeSensorConfigurationList.isEqual(value.getRangeSensorConfigurationList()))
				{
					return false;
				}
			...
			public boolean notEquals(RangeSensorConfigurationSequence value)
			{
				return !this.isEqual(value);
			}
			
			public RangeSensorConfigurationSequence()
			{
				m_parent = null;
			...
			public RangeSensorConfigurationSequence(RangeSensorConfigurationSequence value)
			{
				/// Initiliaze the protected variables
				m_parent = null;
				m_RequestIdRec = new RequestIdRec();
		...
		protected RangeSensorConfigurationSequence m_RangeSensorConfigurationSequence;
	
		public SetRangeSensorConfiguration.Body.RangeSensorConfigurationSequence getRangeSensorConfigurationSequence()
		{
			return m_RangeSensorConfigurationSequence;
		}
		
		public int setRangeSensorConfigurationSequence(RangeSensorConfigurationSequence value)
		{
		...
		public SetRangeSensorConfiguration.Body assign(Body value)
		{
		...
		{
			if (!m_RangeSensorConfigurationSequence.isEqual(value.getRangeSensorConfigurationSequence()))
			{
				return false;
			}
			/// This code is currently not supported
		...
		public Body()
		{
			m_RangeSensorConfigurationSequence = new RangeSensorConfigurationSequence();
			m_RangeSensorConfigurationSequence.setParent(this);
		}
	...
	public SetRangeSensorConfiguration.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public SetRangeSensorConfiguration.Body getBody()
	{
		return m_Body;
	}
	...
	public SetRangeSensorConfiguration setAs(SetRangeSensorConfiguration value)
	{
	...
	public boolean isEqual(SetRangeSensorConfiguration value)
	{
	...
	public boolean notEquals(SetRangeSensorConfiguration value)
	{
		return !isEqual(value);
	}
	
	public SetRangeSensorConfiguration()
	{
	...
	public  SetRangeSensorConfiguration(SetRangeSensorConfiguration value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
