...
public class SetPanTiltJointEfforts extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x0621;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public SetPanTiltJointEfforts.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public SetPanTiltJointEfforts.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public SetPanTiltJointEfforts.AppHeader assign(AppHeader value)
		{
	...
	public static class  Body
	{
		public static class  PanTiltJointEffortRec
		{
			...
			public SetPanTiltJointEfforts.Body.PanTiltJointEffortRec assign(PanTiltJointEffortRec value)
			{
		...
		public SetPanTiltJointEfforts.Body.PanTiltJointEffortRec getPanTiltJointEffortRec()
		{
		...
		public SetPanTiltJointEfforts.Body assign(Body value)
		{
	...
	public SetPanTiltJointEfforts.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public SetPanTiltJointEfforts.Body getBody()
	{
		return m_Body;
	}
	...
	public SetPanTiltJointEfforts setAs(SetPanTiltJointEfforts value)
	{
	...
	public boolean isEqual(SetPanTiltJointEfforts value)
	{
	...
	public boolean notEquals(SetPanTiltJointEfforts value)
	{
		return !isEqual(value);
	}
	
	public SetPanTiltJointEfforts()
	{
	...
	public  SetPanTiltJointEfforts(SetPanTiltJointEfforts value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
