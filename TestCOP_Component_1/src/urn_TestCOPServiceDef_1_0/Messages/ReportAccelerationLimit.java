...
public class ReportAccelerationLimit extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x4416;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public ReportAccelerationLimit.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public ReportAccelerationLimit.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public ReportAccelerationLimit.AppHeader assign(AppHeader value)
		{
	...
	public static class  Body
	{
		public static class  AccelerationLimitRec
		{
			...
			public ReportAccelerationLimit.Body.AccelerationLimitRec assign(AccelerationLimitRec value)
			{
		...
		public ReportAccelerationLimit.Body.AccelerationLimitRec getAccelerationLimitRec()
		{
		...
		public ReportAccelerationLimit.Body assign(Body value)
		{
	...
	public ReportAccelerationLimit.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public ReportAccelerationLimit.Body getBody()
	{
		return m_Body;
	}
	...
	public ReportAccelerationLimit setAs(ReportAccelerationLimit value)
	{
	...
	public boolean isEqual(ReportAccelerationLimit value)
	{
	...
	public boolean notEquals(ReportAccelerationLimit value)
	{
		return !isEqual(value);
	}
	
	public ReportAccelerationLimit()
	{
	...
	public  ReportAccelerationLimit(ReportAccelerationLimit value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
